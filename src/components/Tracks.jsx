...
const Tracks = () => {
  ...
  return (
    <div className="">
      <div className="flex items-center  gap-5 border-b pb-2  border-[#4e4b4b]">
        ...
        <p className="basis-1/4 flex justify-center hidden md:flex">
          <BiTime size="20" />
        </p>
      </div>
      ...
      <ul className="mt-2">
        {playlistTracks[0]?.data?.items.map((item, index) => (
          <SongRow
            ...
            artist={item.track.artists.map((name) => name.name).join(", ")}
